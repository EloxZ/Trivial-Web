<?php // $Id: phpsoap.php,v 1.1 2008-03-03 11:31:01 jgalvez Exp $
/**
...
* @version $Id: phpsoap.php,v 1.1 2008-03-03 11:31:01 jgalvez Exp $
...
function soap_connect($wsdl, $trace=false) {
    try {
        $connection = new SoapClient($wsdl, array('soap_version'=>SOAP_1_1, 'exceptions'=>true, 'trace'=>$trace, 'cache_wsdl'=>WSDL_CACHE_NONE));
    }
    catch (SoapFault $f) {
        $connection = $f;
    }
